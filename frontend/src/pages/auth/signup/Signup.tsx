...
export default function Signup() {
  ...
  const handlePostLogin = async (user: firebase.User) => {
    ...
    const role: 'ADMIN' | 'USER' | undefined = idToken?.claims.role;
  ...
  const validationSchema = Yup.object().shape({
    email: Yup.string().required('Cet adresse courriel est obligatoire').email("Cet adresse courriel n'est pas valide"),
    password: Yup.string()
